...
class App extends React.Component {
    ...
    async initClient () {
        ...
        this.setState({clientKey: data.clientKey});
        this.setState({stations: stations});
        this.setState({stationsKeys: stationsKeys});
    }
    ...
    render () {
        return <div className="main-viewport">
            ...
            {/* Stations */}
            <Stations stations={this.state.stations} stationsKeys={this.state.stationsKeys} />
        </div>;
    }
}
